...
privatefield2 =    pf2
    ...
    |]
    ( [ FieldInfo (FieldKey "field1") "f1"
      , FieldInfo (FieldKey "field2") "f2"
      , FieldInfo (FieldKey "field3") ""
      , FieldInfo (FieldKey "field4") "first line:\n  second line\n  third line\n"
      , FieldInfo (FieldKey "field5") "âД😱👪日本"
      ]
    , [ FieldInfo (FieldKey "privatefield1") "pf1"
      , FieldInfo (FieldKey "privatefield2") "pf2"
